...
config['zfmkidserviceurl'] = "https://id.zfmk.de/dcapi/json/CollectionSpecimen"
...
config['blast'] = {}
config['blast']['blast_db_home'] = c['blast']['blast_db_home']
config['blast']['bold_url'] = c['blast']['bold_url']
config['blast']['ncbi_url'] = c['blast']['ncbi_url']
config['blast']['default_result_size'] = int(c['blast']['default_result_size'])
config['blast']['num_worker_threads'] = int(c['blast']['num_worker_threads'])
...
messages['news_confirm'] = {'de': " Absenden ", 'en': " Send "}
...
messages['news_delete'] = {'de': " Löschen ", 'en': " Delete "}
messages['news_confirm_del'] = {'de': " Löschen bestätigen ", 'en': " Delete news "}
messages['news_cancel_del'] = {'de': " Nicht Löschen ", 'en': " Do not delete "}
...
messages['news_message_deleted'] = {'de': "News gelöscht", 'en': "News deleted"}
messages['news_message_confirm_del'] = {'de': "Bitte Löschen des Newsbeitrags bestätigen", 'en': "Please confirm that news should be deleted"}

messages['pub_message_updated'] = {'en': 'Publication updated!', 'de': 'Publikation bearbeitet!'}
messages['pub_message_saved'] = {'en': 'Publication saved!', 'de': 'Publikation gespeichert!'}
messages['pub_message_empty'] = {'en': 'Please enter title and content of the publications posting!',
						 'de': 'Bitte geben Sie Titel und Inhalt des neuen Publikationsbeitrages ein!'}

messages['docs_message_saved'] = {'de': "Dokument gespeichert!", 'en': "Document saved!"}
messages['docs_message_updated'] = {'de': "Dokument bearbeitet!", 'en': "Document updated!"}
messages['docs_message_empty'] = {'de': "Bitte geben Sie Titel und Inhalt des neuen Beitrages ein!",
								  'en': "Please enter title and content of the posting!"}
messages['docs_message_file_missing'] = {'de': "Bitte w&auml;hlen Sie eine PDF-Datei zum Upload!",
								  'en': "Please select a pdf-file for upload!"}
messages['docs_message_confirm_del'] = {'de': "Löschen des Dokuments bitte best&auml;tigen!",
								  'en': "Please confirm to delete the document!"}
messages['docs_message_deleted'] = {'de': "Dokument gel&ouml;scht",
								  'en': "Document deleted"}
